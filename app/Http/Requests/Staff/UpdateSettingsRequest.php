...
class UpdateSettingsRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'no_show_grace_minutes' => ['required', 'integer', 'min:5', 'max:1440'],
    ...
    public function messages(): array
    {
        return [
            ...
            'no_show_grace_minutes.required' => 'مهلت پیش‌فرض حضور را وارد کنید.',
            'no_show_grace_minutes.min' => 'مهلت حضور کمتر از ۵ دقیقه عملاً یعنی حذف فوری نوبت.',
